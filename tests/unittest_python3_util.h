...
/** @brief Tracked objects a run of calls may leave behind (caches, lazy imports); a leak adds at least one per call */
 ...
 * @note Containers such as lists and tuples are tracked; this is what a leaked list or tuple adds to.
 */
